...
class StackableItem(Item):
    def __init__(self, name: str, effect: str, effect_heal: int, chance: float,
                 stock_price: int, id_item: int, quantity: int = 1,
                 max_stack: int = 20, mob_chances: dict = None) -> None:
        super().__init__(name, effect, effect_heal, chance, stock_price, id_item, mob_chances)
        self.quantity = quantity  # Убедитесь, что quantity инициализируется
...
class Character:
    ...
    def add_item(self, item: Item) -> bool:
        ...
        while item.quantity > 0 and len(self.inventory) < 30:
...
item_database = [
    StackableItem(name="Малое зелье лечения", effect="heal", effect_heal=50, chance=33.3, stock_price=10, id_item=1,mob_chances={"Азог":50}),  # 33.3
...
"""
item_database = [
    StackableItem(name="Малое зелье лечения", effect="heal", effect_heal=50, chance=33.3, stock_price=10, id_item=1, mob_chances={"Азог":50}),
    StackableItem(name="Среднее зелье лечения", effect="heal", effect_heal=100, chance=10.0, stock_price=20, id_item=2, mob_chances={"Азог":20,"Балкмег":30}),
    StackableItem(name="Большое зелье лечения", effect="heal", effect_heal=200, chance=5.0, stock_price=50, id_item=3, mob_chances={"Азог":10,"Балкмег":18}),
    Equipment(name="Шлем рыцаря", slot="Голова", effect="defence", effect_value=5, chance=5.0, stock_price=100, id_item=4),
    Equipment(name="Кираса рыцаря", slot="Тело", effect="defence", effect_value=10, chance=5.0, stock_price=200, id_item=5, mob_chances={"Балкмег":7}),
    Equipment(name="Перчатки силы", slot="Руки", effect="attack", effect_value=3, chance=5.0, stock_price=75, id_item=6),
    Equipment(name="Сапоги ловкости", slot="Ноги", effect="defence", effect_value=3, chance=5.0, stock_price=75, id_item=7),
    Equipment(name="Меч воина", slot="Оружие", effect="attack", effect_value=10, chance=5.0, stock_price=150, id_item=8),
    Equipment(name="Плащ теней", slot="Плащ", effect="defence", effect_value=7, chance=5.0, stock_price=100, id_item=9, mob_chances={"Балкмег":7}),
    Equipment(name="Старые перчатки", slot="Руки", effect="defence", effect_value=1, chance=20.0, stock_price=8, id_item=10),
    Equipment(name="Старые сапоги", slot="Ноги", effect="defence", effect_value=2, chance=2.0, stock_price=8, id_item=11, mob_chances={"Внизуда":0}),
]
"""
